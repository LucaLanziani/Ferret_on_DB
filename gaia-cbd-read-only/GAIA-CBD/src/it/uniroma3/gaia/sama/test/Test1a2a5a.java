...
/**
 * Questa classe testa i passi 1a,2a,5a dell'algoritmo . <br />
 * COURSE(<i>cod</i>,name)-> DEPT(<i>id</i>,cod,name)
 */
public class Test1a2a5a {
	...
	public static void Passo1a2a5a() {
		...
		dataExchange.addAttributeKeyToTarget("DEPT", "id");
		
		// Aggiunge un attributo chiave a Dept
		dataExchange.addAttributeToTarget("DEPT", "cod");
