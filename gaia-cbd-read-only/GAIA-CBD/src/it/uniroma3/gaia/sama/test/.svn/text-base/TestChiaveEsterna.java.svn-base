...
/**
 * Questa classe testa i passi 1,1.5,2,4 dell'algoritmo . <br />
 * COURSE(<i>cod</i>), STUDENT(<i>id</i>,sname,<b>corso</b>) -> COURSE(<i>cod</i>,name,univ), STUDENT(<i>id</i>,sname,<b>corso</b>)
 */

public class TestChiaveEsterna {
	...
	public static void Passo124() throws Exception {
		...
		// Aggiunge un attributo chiave esterna a Student
		dataExchange.addAttributeFkeyToTarget("STUDENT", "COURSE", "corso");
