 ...
 * DEPT(<i>did</i>,cid,num,desc)-> EMP(<i>did</i>,desc),CICCIO(<i>cic</i>,num)
 */

public class Test1a25bd {
	...
	public static void Passo1a25bd() {
		...
		//Creazione del data exchange target
		// Aggiunge una relazione
		dataExchange.addRelationToTarget("CICCIO");
		
		// Aggiunge un attributo chiave a Ciccio
		dataExchange.addAttributeKeyToTarget("CICCIO", "cic");
		
		// Aggiunge l'attributo a Ciccio
		dataExchange.addAttributeToTarget("CICCIO", "num");
